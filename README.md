<picture>
  <source media="(prefers-color-scheme: dark)" srcset="dark.svg?v=8">
  <source media="(prefers-color-scheme: light)" srcset="light.svg?v=8">
  <img alt="Himanshu Menghani - Full Stack Developer &amp; AI Engineer" src="dark.svg?v=8" width="100%">
</picture>
...
class HimanshuMenghani {
    ...
    String   status     = "Full-Stack Developer | Self-taught | Open to Work";
...
Full-stack developer from Mumbai focused on building real products — not just tutorials.
I build web apps, mobile apps, and AI-powered tools using modern stacks and LLM APIs.
27 certifications across cloud, AI, and web development. No CS degree. All shipped code.

Currently targeting SDE roles at product companies and actively building in public.
